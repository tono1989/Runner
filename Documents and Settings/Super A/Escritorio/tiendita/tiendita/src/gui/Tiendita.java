...
public class Tiendita extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(54, 54, 54)
                        .addComponent(lableTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void agregarALaLista(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_agregarALaLista
        ...
        try{
            if (code  == 10 || code == 13){
                ...
                {
                    cell = (String)listaDeProductos.getValueAt(i, 0);
                    if (cell.equalsIgnoreCase(upc)){
                        cantidad = Integer.parseInt((String)modelo.getValueAt(i, 2));
                        cantidad ++;
                ...
                if (existeUPC)
                    modelo.addRow(producto.getStringArrayVender());
            ...
            //BD.reportarError("agregarProducto. " + e.getMessage());
            System.out.println("agregarProducto. " + e.getMessage() );
        }
    ...
    private void buttonGuardarAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonGuardarAgregarMouseClicked
        ...
        for (int row = 0; row < num_row; row++){
            ...
            try{
                ...
                costo = (Float)modelo.getValueAt(row,3);
    ...
    private void buttonBuscarAdminMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonBuscarAdminMouseClicked
        try{
            Integer.parseInt(textUpcAdmin.getText());
            ...
            int num_row = modelo.getRowCount();
            if (num_row == 0 )
                modelo.addRow(p.getStringArray());
